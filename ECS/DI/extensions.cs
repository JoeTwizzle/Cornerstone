...
namespace Leopotam.EcsLite.Di {
    ...
    public static class Extensions {
        ...
        public static EcsSystems Inject(this EcsSystems systems, params object[] injects) {
            ...
            int count = systems.GetAllSystems(ref allSystems);
            Inject(systems, count, allSystems, injects);
            return systems;
        }

        public static EcsSystems Inject (this EcsSystems systems, int systemsCount, IEcsSystem[] allSystems, params object[] injects) {
